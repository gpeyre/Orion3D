...
// Last modified: 09/20/2001 <--Y2K Compliant! =]
//
// Filename: il/il.h
//
...
#define IL_VERSION_1_1_5					1
#define IL_VERSION							115
...
typedef ILHANDLE	(ILAPIENTRY *fOpenRProc) (const char*);
...
typedef ILHANDLE	(ILAPIENTRY *fOpenWProc) (const char*);
...
typedef ILboolean	(ILAPIENTRY *IL_LOADPROC)(const char*);
typedef ILboolean	(ILAPIENTRY *IL_SAVEPROC)(const char*);
...
ILAPI ILboolean		ILAPIENTRY ilApplyPal(const char *FileName);
...
ILAPI ILboolean		ILAPIENTRY ilIsValid(ILenum Type, const char *FileName);
...
ILAPI ILboolean		ILAPIENTRY ilLoad(ILenum Type, const char *FileName);
ILAPI ILboolean		ILAPIENTRY ilLoadF(ILenum Type, ILHANDLE File);
ILAPI ILboolean		ILAPIENTRY ilLoadImage(const char *FileName);
ILAPI ILboolean		ILAPIENTRY ilLoadL(ILenum Type, ILvoid *Lump, ILuint Size);
ILAPI ILboolean		ILAPIENTRY ilLoadPal(const char *FileName);
...
ILAPI ILboolean		ILAPIENTRY ilRegisterLoad(const char *Ext, IL_LOADPROC Load);
...
ILAPI ILboolean		ILAPIENTRY ilRegisterSave(const char *Ext, IL_SAVEPROC Save);
ILAPI ILvoid		ILAPIENTRY ilRegisterType(ILenum Type);
ILAPI ILboolean		ILAPIENTRY ilRemoveLoad(const char *Ext);
ILAPI ILboolean		ILAPIENTRY ilRemoveSave(const char *Ext);
...
ILAPI ILboolean		ILAPIENTRY ilSave(ILenum Type, const char *FileName);
ILAPI ILboolean		ILAPIENTRY ilSaveF(ILenum Type, ILHANDLE File);
ILAPI ILboolean		ILAPIENTRY ilSaveImage(const char *FileName);
ILAPI ILboolean		ILAPIENTRY ilSaveL(ILenum Type, ILvoid *Lump, ILuint Size);
ILAPI ILboolean		ILAPIENTRY ilSavePal(const char *FileName);
...
ILAPI ILboolean		ILAPIENTRY ilLoadData(const char *FileName, ILuint Width, ILuint Height, ILuint Depth, ILubyte Bpp);
...
ILAPI ILboolean		ILAPIENTRY ilSaveData(const char *FileName);
