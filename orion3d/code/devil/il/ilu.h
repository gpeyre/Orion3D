...
#define ILU_VERSION_1_1_5					1
#define ILU_VERSION							115
...
ILAPI const ILbyte*	ILAPIENTRY iluErrorString(ILenum Error);
...
ILAPI const char*	ILAPIENTRY iluGetString(ILenum StringName);
ILAPI ILvoid		ILAPIENTRY iluImageParameter(ILenum PName, ILenum Param);
ILAPI ILvoid		ILAPIENTRY iluInit(ILvoid);
ILAPI ILuint		ILAPIENTRY iluLoadImage(const char *FileName);
