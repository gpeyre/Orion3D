...
void TestLua()
{
	WrapperLUA.DoString( "print(\":: Wellcome to Orion3D LUA Wrapper test programm ::\")" );
	WrapperLUA.DoFile("test.lua");
}
...
int main( int argc, char *argv[ ], char *envp[ ] )
{
	...
	GlWin=pInputOutput->Initialisation_Win32(NULL,NULL,0,"-==[ Test for LUA ]==-",640,480,0,0);
