/*------------------------------------------------------------------------------*/
/** 
 *  \file  OR_BitmapFont.cpp
 *  \brief Definition of class \c OR_BitmapFont
 *  \author Gabriel Peyré 2001-11-13
 */ 
/*------------------------------------------------------------------------------*/
#ifdef OR_SCCSID
static const char* sccsid = "@(#) OR_BitmapFont.cpp (c) Gabriel Peyré & Antoine Bouthors 2001";
#endif // OR_SCCSID
...
/*------------------------------------------------------------------------------*/
/** 
 * Name : OR_BitmapFont::Draw
 *
 *  \param  text the text to output.
 *  \author Gabriel Peyré 2001-11-13
 */ 
/*------------------------------------------------------------------------------*/
void OR_BitmapFont::Draw(char* text)
{
	OR_ASSERT( text!=NULL );
