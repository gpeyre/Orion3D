/*------------------------------------------------------------------------------*/
/** 
 *  \file  OR_DampedSpringConstraint.h
 *  \brief Definition of class OR_DampedSpringConstraint
...
/*------------------------------------------------------------------------------*/
/** 
 *  \class  OR_DampedSpringConstraint
...
class ORION3D_API OR_DampedSpringConstraint: public OR_SpringConstraint
{

public:

    OR_DampedSpringConstraint(OR_Float rStiffness = 0.005f, OR_Float rLength = 1, OR_Float rDampling=0,
					OR_Particule* pTarget1=NULL,
					OR_Particule* pTarget2=NULL);
    virtual ~OR_DampedSpringConstraint();
