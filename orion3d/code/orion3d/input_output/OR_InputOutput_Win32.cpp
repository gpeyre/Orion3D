...
#ifdef OR_SCCSID
static const char* sccsid = "@(#) OR_InputOutput_Win32.cpp (c) Gabriel PeyrÈ & Antoine Bouthors 2001";
#endif // OR_SCCSID
...
/*
	...
	( 
		"Orion3D window",			//Classe de la fenÕtre
		name,						//Nom de la fenÕtre
		WS_VISIBLE | WS_SYSMENU,	//Caract»ristiques
		0,						//Position x
		0,						//Position y
		640,						//Largeur
		480,						//Hauteur
		0,						//Handle de la fenÕtre mÀre
		0,						//Identifiant de la fenÕtre fille
...
void OR_InputOutput::SetupPixelFormat(HDC hDC)
{
	PIXELFORMATDESCRIPTOR pfd=
	{
        ...
        16,								//Bits de couleur
        0, 0, 0, 0, 0, 0,				//ParamÀtres des couleurs
        0, 0,							//ParamÀtres alpha
        0, 0, 0, 0, 0,					//ParamÀtres du buffer d'accumulation
