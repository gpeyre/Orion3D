...
/*------------------------------------------------------------------------------*/
// Name : GW_GeodesicVertex::GetHeuristic
/**
*  \return [GW_Float] Current Heuristic to goal.
*  \author Gabriel Peyré
*  \date   4-9-2003
* 
*  Get the current distance.
...
/*------------------------------------------------------------------------------*/
GW_INLINE
GW_Float GW_GeodesicVertex::GetHeuristic()
{
    return rHeuristic_;
}
...
// Name : GW_GeodesicVertex::SetDistance
/**
*  \param  rH [GW_Float] New heuristic to goal.
*  \author Gabriel Peyré
*  \date   4-9-2003
* 
*  Set the current distance.
...
/*------------------------------------------------------------------------------*/
GW_INLINE
void GW_GeodesicVertex::SetHeuristic( GW_Float rH )
{
    rHeuristic_ = rH;
}
...
{
	return pVert1->GetDistance()+pVert1->GetHeuristic()>pVert2->GetDistance()+pVert2->GetHeuristic();
}
