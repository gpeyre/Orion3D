...
public:
	...
	*/
	/*------------------------------------------------------------------------------*/
	GW_Float GW_Maths::SphericalTriangleArea(const GW_Vector3D& v1, const GW_Vector3D& v2, const GW_Vector3D& v3)
	{
	...
	*/
	/*------------------------------------------------------------------------------*/
	static GW_Float GW_Maths::FlatTriangleArea(const GW_Vector3D& v1, const GW_Vector3D& v2, const GW_Vector3D& v3)
	{
	...
	*/
	/*------------------------------------------------------------------------------*/
	static GW_Float GW_Maths::FlatQuadrilaterArea( const GW_Vector3D& v1, const GW_Vector3D& v2, const GW_Vector3D& v3, const GW_Vector3D& v4 )
	{
		GW_Float rArea = 0;
	...
	*/
	/*------------------------------------------------------------------------------*/
	static void GW_Maths::FlatTriangleNormal(GW_Vector3D& Normal, const GW_Vector3D& v1, const GW_Vector3D& v2, const GW_Vector3D& v3)
	{
		Normal = (v2-v1)^(v3-v1);
	}
	...
	*/
	/*------------------------------------------------------------------------------*/
	static GW_Float GW_Maths::ComputeTriangleArea( GW_Float a, GW_Float b, GW_Float c )
	{
	...
	*/
	/*------------------------------------------------------------------------------*/
	static void GW_Maths::ConvertCartesianToSpherical(const GW_Vector3D& Pos, GW_Float& rLong, GW_Float& rLat)
	{
		GW_ASSERT( Pos[0] <= 1 );
		GW_ASSERT( Pos[0] >= -1 );
		GW_ASSERT( Pos[2] <= 1 );
	...
	static void GW_Maths::SolveLU( GW_Float **a, GW_I32 n, GW_Float *b )
	{
		GW_Float d;
	...
	*/
	/*------------------------------------------------------------------------------*/
	static void GW_Maths::Fit2ndOrderPolynomial2D( const GW_Float Points[6][2], const GW_Float Values[6], GW_Float Coeffs[6] )
	{
		/* build the matrix */
	...
	*/
	/*------------------------------------------------------------------------------*/
	static GW_I32 GW_Maths::ComputeLocalGeodesicParameter( GW_Float& x, GW_Float& y, GW_Float& z, 
	...
	*/
	/*------------------------------------------------------------------------------*/
	static void GW_Maths::TestClass(std::ostream &s = cout)
	{
