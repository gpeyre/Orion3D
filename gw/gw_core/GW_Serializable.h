...
public:
	...
	/** constructor */
	GW_Ofstream(const char* name, GW_I32 mode = std::ios_base::binary | std::ios_base::trunc)
...
public:
	...
	GW_Ifstream(const char* name, GW_I32 mode = std::ios_base::binary)
