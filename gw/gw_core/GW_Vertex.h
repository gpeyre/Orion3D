...
class GW_Vertex:	public GW_SmartCounter,	public GW_Serializable
{
...
public:
	...
	void BuildFromFile( GW_Ifstream& file);
	/** export the data from the object to an opened file */
	void BuildToFile( GW_Ofstream& file );
	GW_DEFINE_SERIALIZATION(GW_Vertex);
	//@}
