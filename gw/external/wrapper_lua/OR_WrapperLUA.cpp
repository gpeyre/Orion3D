...
/*------------------------------------------------------------------------------*/
// Name : OR_WrapperLUA::GetError
/**
 *  \return [bool] Yes/No
 *  \author Gabriel Peyré
 *  \date   11-18-2002
 * 
 *  Was the last parsing succesful ?
 */
/*------------------------------------------------------------------------------*/
bool OR_WrapperLUA::GetError()
{
	return nError_!=0;
}

/*------------------------------------------------------------------------------*/
// Name : OR_WrapperLUA::GetErrorString
/**
 *  \return [const char*] Description.
 *  \author Gabriel Peyré
 *  \date   11-18-2002
 * 
 *  Get a short descption of the error.
 */
/*------------------------------------------------------------------------------*/
const char* OR_WrapperLUA::GetErrorString()
{
	return strerror( nError_ );
}
